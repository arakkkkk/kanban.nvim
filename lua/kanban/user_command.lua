...
local function safe_del_cmd(name)
	pcall(vim.api.nvim_del_user_command, name)
end

function M.del()
	-- Task
	safe_del_cmd("KanbanTaskDelete")
	safe_del_cmd("KanbanTaskToggleComplete")
	-- Task movement
	safe_del_cmd("KanbanTakeRight")
	safe_del_cmd("KanbanTakeLeft")
	safe_del_cmd("KanbanTakeUp")
	safe_del_cmd("KanbanTakeDown")
	safe_del_cmd("KanbanMoveDown")
	safe_del_cmd("KanbanMoveUp")
	safe_del_cmd("KanbanMoveRight")
	safe_del_cmd("KanbanMoveLeft")
	safe_del_cmd("KanbanMoveTop")
	safe_del_cmd("KanbanMoveBottom")
	safe_del_cmd("KanbanTaskAdd")
	safe_del_cmd("KanbanTaskAddBottom")
	safe_del_cmd("KanbanTaskAddTop")
	safe_del_cmd("KanbanClose")
	safe_del_cmd("KanbanSave")
	safe_del_cmd("KanbanListDelete")
	safe_del_cmd("KanbanListRename")
	safe_del_cmd("KanbanListAdd")
	-- Description note
	safe_del_cmd("KanbanTaskDescription")
	safe_del_cmd("KanbanTaskDescriptionSetHeader")
end
